...
public class ProductoDAOHttp implements ProductoDAO {
    ...
    public List<ProductoMenu> listarMenu() {
        ...
        try {
            //original "http://10.0.2.2:5000/productos"
            //Emulo con genymotion http://10.0.3.2:5000/productos
            URL url = new URL("http://10.0.3.2:5000/productos");
            ...
            JSONArray listaProducto = (JSONArray) new
                    JSONTokener(sb.toString()).nextValue();
...
// este metodo no es necesario porque se obtienen datos del API REST
    }
}
