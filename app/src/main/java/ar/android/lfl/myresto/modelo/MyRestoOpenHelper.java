...
public class MyRestoOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE PEDIDO_DETALLE ( _id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ID_PRODUCTO INTEGER, CANTIDAD INTEGER, ID_PEDIDO INTEGER) ");
        db.execSQL("CREATE TABLE PEDIDO ( _id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, NOMBRE TEXT, ENVIO_DOMICILIO INTEGER, " + "BEBIDA_XL INTEGER,PERMITE_CANCELAR INTEGER,INCLUYE_PROPINA INTEGER, ENVIAR_NOTIFICACION INTEGER, PAGO_AUTOMATICO INTEGER, ESTADO INTEGER) ");
